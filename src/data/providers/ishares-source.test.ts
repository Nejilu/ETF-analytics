...
test("adds the current Swiss CSV endpoint for legacy UK downloads", () => {
  const legacyUrl =
    "https://www.ishares.com/uk/individual/en/products/253743/fund/1506575576011.ajax?fileType=csv&fileName=CSPX_holdings&dataType=fund";

  assert.deepEqual(holdingsSourceCandidates(legacyUrl), [
    legacyUrl,
    "https://www.ishares.com/ch/individual/en/products/253743/fund/1495092304805.ajax?fileType=csv&fileName=CSPX_holdings&dataType=fund",
  ]);
});
