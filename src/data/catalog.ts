...
export const ETF_CATALOG: CatalogGroup[] = [
  {
    ...
    description: "Les 500 principales sociétés cotées américaines.",
    variants: [
      {
        id: "ivv-us",
        ticker: "IVV",
  ...
  },
  {
    ...
    name: "MSCI World",
    provider: "MSCI",
    region: "Marchés développés · monde",
    description: "Grandes et moyennes capitalisations de 23 marchés développés.",
    variants: [
      {
        id: "urth-us",
        ticker: "URTH",
      ...
      },
      {
        ...
        holdingsUrl:
          "https://www.ishares.com/uk/individual/en/products/251882/ishares-core-msci-world-ucits-etf/1506575576011.ajax?fileType=csv&fileName=SWDA_holdings&dataType=fund",
      },
    ],
  },
  {
    ...
    name: "MSCI ACWI",
    provider: "MSCI",
    region: "Marchés développés + émergents",
    description: "Une exposition globale tout pays en une seule allocation.",
    variants: [
      {
        id: "acwi-us",
        ticker: "ACWI",
  ...
  },
  {
    ...
    provider: "MSCI",
    region: "Marchés émergents · toutes capitalisations",
    description: "Large, mid et small caps des économies émergentes.",
    variants: [
      {
        id: "iemg-us",
        ticker: "IEMG",
  ...
  },
  {
    ...
    description: "Le segment small caps du marché actions américain.",
    variants: [
      {
        id: "iwm-us",
        ticker: "IWM",
